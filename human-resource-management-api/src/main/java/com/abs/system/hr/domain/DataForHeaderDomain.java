...
@Getter
@Setter
public final class DataForHeaderDomain implements Serializable {
    ...
    public DataForHeaderDomain() {
        try {
            this.initialVariable();
        } catch (IllegalArgumentException | IllegalAccessException ex) {
            Logger.getLogger(DataForHeaderDomain.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
