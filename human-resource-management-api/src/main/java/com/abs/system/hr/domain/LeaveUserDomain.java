...
@Getter
@Setter
public final class LeaveUserDomain implements Serializable {
    ...
    public LeaveUserDomain() {
        try {
            this.initialVariable();
        } catch (IllegalArgumentException | IllegalAccessException ex) {
            Logger.getLogger(LeaveUserDomain.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
